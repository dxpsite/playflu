...
?>
  ...
  <link rel="stylesheet" href="/shed/slider/css/ion.rangeSlider.css" />
  <link rel="stylesheet" href="/shed/slider/css/normalize.css" />
    <link rel="stylesheet" href="/shed/slider/css/ion.rangeSlider.skinHTML5.css" />
    <script src="serverDate.js"></script>
      <script src="bootstrap-notify.js"></script>
      <script src="/shed/slider/js/ion.rangeSlider.js"></script>
    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="https://subty.ru/upload/">Upload</a></li> 
...
$duration_2 = gmdate("H:i:s", $duration);

echo '<li id="'.$row["id"].'">'.$row["name"].'<br>  <h6><span class="label label-primary">'.$duration.'</span> or <span class="label label-success">'.$duration_2.' seconds</span></h6>
  ...
  if ($array['stored'] == 1)
{
    ...
    echo "#EXTINF:".$array['duration']."<br>privat/".$array['name']." <br>";
 ...
 else
{
  ...
  echo "#EXTINF:".$array['duration']."<br>locale/".$array['name']." <br>";
    $test = "#EXTINF:".$array['duration']."\nlocale/".$array['name']."\n";
