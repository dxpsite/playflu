...
$data=json_decode(file_get_contents("https://api.themoviedb.org/3/search/movie?api_key=0d2861372b5b46a514fa633fee10594f&language=ru&query=$title&page=1&include_adult=true"),true);
...
for ($i=0;$i <$count; $i++) { 
  ...
  <div class="overlay">';
  ?>
   <input type="button" value="Insert" onclick="insertText('<?php echo $id;?>');">
        <!--<a href="" class="icon" id="adddata" title="'.$id.'">
