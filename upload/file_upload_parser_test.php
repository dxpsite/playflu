...
move_uploaded_file($fileTmpLoc, "/code/media/files/$fileName");

$duration = shell_exec("ffprobe -i /code/media/files/" .$fileName. " -show_entries format=duration -v quiet -of csv=\"p=0\"");
...
$sql = "INSERT HIGH_PRIORITY INTO media (name, size, duration, media_order, tmdb, encoded) VALUES ('".$fileName."', '".$fileSize."', '0','0','".$tmdbtitle."','".$encoded."')";
//$mysqli->query($sql);
...
//$container = substr($fileType, 6);
$sql = "INSERT HIGH_PRIORITY INTO media (name, size, duration, media_order, tmdb, captions) VALUES ('".$fileName."', '".$fileSize."','0','0','".$tmdbtitle."', '".$subsName."')";
//$mysqli->query($sql);
//printf ("ID новой записи: %d.\n", $mysqli->insert_id);
